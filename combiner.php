    ...
    this.onblur=function(){
	 ...
	 if(isset($_POST['liste'])) {
		...
		if(isset($_POST['liste']) AND isset($_POST['liste2']) AND $_POST['liste'] != null AND $_POST['liste2'] != null) {
			?>Vous allez réviser la combinaison de <a href="afficher.php?id=<?php echo $_POST['id']?>"><?php echo $_POST['titre']?></a> et de <a href="afficher.php?id=<?php echo $_POST['id2']?>"><?php echo $_POST['titre2']?></a><br />
			<?php
			if(isset($_SESSION['login'])) {
				if(isset($_POST['sauvegarder'])) {
					...
					$titre = '<a href="afficher.php?id='.$_POST['id'].'">'.$_POST['titre'].'</a> et de <a href="afficher.php?id='.$_POST['id2'].'">'.$_POST['titre2'].'</a>';
				...
				?>
				<br /><form method="post" action="combiner.php" >
		...
		<form method="post" >
			...
			?>
			<p>Avec quelle liste voulez-vous combiner <a href="afficher.php?id=<?php echo $_POST['id']?>"><?php echo $_POST['titre']?></a>?</p>
