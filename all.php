...
<a href="recherche.php" >Faire une recherche</a><br />
...
$retour_total=mysql_query('SELECT COUNT(*) AS total FROM listes_public'); //Nous récupérons le contenu de la requête dans $retour_total
...
for($i=1; $i<=$nombreDePages; $i++) //On fait notre boucle
{
     ...
     {
          echo ' <a href="all.php?page='.$i.'&class='.$_SESSION['classement'].'">'.$i.'</a> ';
     }
}
echo '</p>';
?>
