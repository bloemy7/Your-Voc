				...
				<input type="hidden" name="choix" value="1" /> 
					...
					<div id="exemple">
						<div style="margin:4px;">
							Afin de saisir une nouvelle liste, entrez le mot dans le champ de gauche, et la traduction dans le champ de droite.
							pour passer dans le champ de droite vous pouvez saisir '='.
							Afin d'ajouter un nouveau cliquez sur entrée dans l'un des 2 champs, la touche '+' ou le bouton , ou cliquer sur le bouton +.
							<div style="margin:4px;">
								exemple : <br>
								<input value="eat" disabled style ="font-style:italic" /> = <input value="manger" disabled style ="font-style:italic" />
							</div>
							<div style="margin:4px;">
								Afin de vous permettre de mettre plusieurs traduction pour un mot, vous pouvez faire comme ceci :<br>
								<input value="hello" disabled style ="font-style:italic" /> = <input value="salut/bonjour" disabled style ="font-style:italic" />
							</div>
						</div>
					</div>
					...
					<div class="contentEntrerListe" id="etape1" style="display:none;">
						...
						<p>	
							...
							<table id="listeMots"  style="color:white">
								<tbody>
									<tr>
										<td width="200" align="right">ajouter un mot</td>
										<td width="150">votre mot</td>
										<td width="8"></td>
										<td width="150">votre traduction</td>
										<td width="400" align="left">ajouter un commentaire pour le mot</td>
									</tr>
									<tr>
										<td></td>
										<td><input name="mot0" value="" /></td>
										<td> = </td>
										<td><input name="trad0" value="" /></td>
										<td align="left">											
											<span id="comment0" style="display:none;"> commentaire : <input name="comment0" value="" /></span>
											<img src="images/comment_add.png" title="ajouter un commentaire" alt="ajouter un commentaire" style="vertical_align:middle;cursor:pointer" onclick="$('#comment0').show();$(this).hide();" />
										</td>
									</tr>
									<tr>
										<td align="right"><img src="images/add.png" title="ajouter un mot" alt="ajouter un mot" style="vertical_align:middle;cursor:pointer" onclick="ajouterMot(this);" /></td>
										<td></td>
										<td></td>
										<td></td>
										<td align="left"></td>
						...
						<!--							
						<br>
						<textarea name="mots" rows="15" cols="70" id="newListe"><?php echo $_POST['mots'];?></textarea><br />
						-->
